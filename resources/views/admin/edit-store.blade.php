                            ...
                            <div class="row pb-2">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="name" id="name"
                                        autocomplete="off" value="{{$store->name}}">
                                </div>
                            </div>
                            <div class="row pb-4">
                            ...
                            <div class="row pb-4">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="latitude" autocomplete="off"
                                        id="latitude" value="{{$store->latitude}}">
                                </div>
                            </div>
                            <div class="row pb-4">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="longitude" autocomplete="off"
                                        id="longitude" value="{{$store->longitude}}">
                                </div>
                            </div>
                            <div class="text-left">
                                <button type="submit" class="btn bestway-btn me-3">Update</button>
                            </div>
